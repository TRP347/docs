...
For best latency, send audio in **100-300ms binary chunks **(e.g., 3200-9600 bytes at 16 kHz). Smaller chunks reduce dlay and produce faster partial transcripts. Using `linear16` at 16 kHz is the recommended configuration for real-time speech recognition.